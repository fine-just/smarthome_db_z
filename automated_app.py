...
if __name__ == "__main__":
    ...
    style = r"C:\Users\Zisis\Downloads\smarthome-main (6)\smarthome-main\style.txt"
    ###----------
...
##
    ...
    #cursor.execute("SELECT device_id FROM syskeyi")
    ...
    for i in mycol1.find({},{ "_id": 1}):
        ...
        c=str(b)
        b=(str(b),)
        #cursor.execute("""SELECT device_id FROM syskeyi where device_id=?;""",b)

        #cursor.execute(f"""INSERT INTO syskeyi(device_id,eidos,dwmatio,energi,kwh) SELECT """+"""'"""+c+"""'"""+""",'lampa3','kouzina',false,0.0001 WHERE NOT EXISTS(SELECT device_id,eidos,dwmatio,energi,kwh FROM syskeyi where device_id="""+"""'"""+c+"""'"""+""" )""")
        #cursor.execute(f"""INSERT INTO syskeyi(device_id,eidos,dwmatio,energi,kwh) SELECT '5fd688720cc1ed38ec8a7011','lampa3','kouzina',false,0.0001 WHERE NOT EXISTS(SELECT device_id,eidos,dwmatio,energi,kwh FROM syskeyi where device_id='5fd688720cc1ed38ec8a7011' )""")
        cursor.execute("""INSERT OR IGNORE INTO syskeyi(device_id,eidos,dwmatio,energi,kwh)
